      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-center gap-10">
        ...
        <div className="text-center max-w-4xl space-y-6 animate-fade-in-up delay-100">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-foreground leading-[1.1]">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-[#A020F0] to-[#b84df5]">
              {t("hero.title_part3")}
            </span>
          </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 animate-fade-in-up delay-200 w-full justify-center">
          <Link href={`/${i18n.language}/about-us`}>
            <Button
              size="lg"
              variant="outline"
              className="rounded-full border-[#A020F0] cursor-pointer text-[#A020F0] hover:bg-[#A020F0] hover:text-white px-8 h-12 text-base font-bold transition-all duration-300 hover:shadow-[0_0_20px_rgba(160,32,240,0.3)] bg-transparent w-full sm:w-auto"
            >
          ...
          <Link href={`/${i18n.language}/programs`}>
            <Button
              size="lg"
              className="rounded-full bg-[#A020F0] cursor-pointer hover:bg-[#7C1BB0] text-white px-8 h-12 text-base font-bold transition-all duration-300 shadow-lg shadow-[#A020F0]/25 hover:shadow-[#A020F0]/40 hover:-translate-y-0.5 w-full sm:w-auto"
            >
